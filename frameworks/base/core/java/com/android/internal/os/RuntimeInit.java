...
public class RuntimeInit {
    ...
    protected static Runnable applicationInit(int targetSdkVersion, String[] argv,
        ...
        VMRuntime.getRuntime().setTargetHeapUtilization(0.75f);//设置虚拟机的内存利用率参数值为0.75
        ...
        return findStaticMain(args.startClass, args.startArgs, classLoader);//调用startClass的static方法 main()
    }
