...
public final class ActivityThread extends ClientTransactionHandler {
    ...
    private class ApplicationThread extends IApplicationThread.Stub {
        ...
        public final void bindApplication(String processName, ApplicationInfo appInfo,
            ...
            data.processName = processName;//设置进程名
            ...
            if (packageInfo == null || (packageInfo.mResources != null
                ...
                packageInfo =
                    new LoadedApk(this, aInfo, compatInfo, baseLoader,
                            ...
                            (aInfo.flags&ApplicationInfo.FLAG_HAS_CODE) != 0, registerPackage); //创建LoadedApk对象
                ...
                if (differentUser) {
                    // Caching not supported across users
                } else if (includeCode) {//将新创建的LoadedApk加入到mPackages
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        final ContextImpl appContext = ContextImpl.createAppContext(this, data.info);// 创建ContextImpl上下文
        ...
        try {
            ...
            app = data.info.makeApplication(data.restrictedBackupMode, null);// 此处data.info是指LoadedApk, 通过反射创建目标应用Application对象
            ...
            try {
                mInstrumentation.callApplicationOnCreate(app); //回调onCreate
            } catch (Exception e) {
        ...
        if (!system) {
            ...
            try {//system进程才执行该流程
                ...
                ContextImpl context = ContextImpl.createAppContext(
                        this, getSystemContext().mPackageInfo);//根据LoadedApk对象来创建ContextImpl，对于system进程LoadedApk对象取值为mSystemContext
    ...
    public static void main(String[] args) {
        ...
        ActivityThread thread = new ActivityThread();//是线程？ UI
