...
public final class LoadedApk {
     ...
     */
    LoadedApk(ActivityThread activityThread) {//系统创建流程才走这
        mActivityThread = activityThread;
    ...
    private void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        if (mPackageName.equals("android")) {
            ...
            if (mBaseClassLoader != null) {
                ...
                mClassLoader = ClassLoader.getSystemClassLoader(); //创建Classloader对象
            }
            mAppComponentFactory = createAppFactory(mApplicationInfo, mClassLoader);
        ...
        if (mRegisterPackage) {// 当包名不为"android"的情况
            try {
        ...
        if (!mIncludeCode) {
            if (mClassLoader == null) {
                ...
                mClassLoader = ApplicationLoaders.getDefault().getClassLoader(
                        ...
                        null /* classLoaderName */);//获取ClassLoader对象
    ...
    public Application makeApplication(boolean forceDefaultAppClass,
        ...
        if (mApplication != null) {//保证一个LoadedApk对象只创建一个对应的Application对象
            return mApplication;
        }
        ...
        try {
            ...
            app = mActivityThread.mInstrumentation.newApplication(
                    cl, appClass, appContext); //创建Application对象
